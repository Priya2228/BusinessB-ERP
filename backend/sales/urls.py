...
urlpatterns = [
    ...
    path('jobcards/', jobcard_list_create),
    path('jobcards/<int:pk>/', jobcard_detail_update_delete),
    path('jobcards/<int:pk>/generate-grn/', jobcard_generate_grn),
    path('operation-head-registrations/', operation_head_registration_list_create),
    path('operation-head-registrations/<int:pk>/', operation_head_registration_detail_update_delete),
    path('operation-head-registrations/<int:pk>/notify-supervisor/', operation_head_registration_notify_supervisor),
    ...
    path('sales-services/ensure-completion-estimations/', ensure_completion_cost_estimations, name='ensure_completion_cost_estimations'),
    path('users/sales-leads/', sales_leads_list, name='sales_leads_list'),
    path('users/supervisors/', supervisors_list, name='supervisors_list'),
