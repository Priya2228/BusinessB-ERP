...
export default function HeadQuotationListPage() {
    ...
    return (
      <div className="flex flex-col items-start gap-1.5">
        ...
        <p className="text-[10px] text-slate-500">
          MD Status: {getStageLabel(record.md.status, "WAITING FOR MD APPROVAL")}
        </p>
        {record.head.comment ? (
      ...
      <div className="mt-3 mx-auto max-w-[1180px] rounded-[20px] border border-sky-100 bg-[#fbfdff] p-4 shadow-[0_8px_28px_rgba(15,23,42,0.05)]">
        ...
        <div className="mt-4 overflow-hidden rounded-[14px] border border-slate-200">
          {loading ? (
            ...
            <div className="px-4 py-12 text-center text-[13px] text-slate-500">No quotations sent to head.</div>
          ) : (
