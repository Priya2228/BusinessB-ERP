...
const quickLinks = [
  { title: "Opening Stock", icon: Boxes, href: "/stock/opening" },
  { title: "Opening List", icon: List, href: "/stock/opening" },
  { title: "Stock Allocation", icon: PackageOpen, href: "/stock/opening" },
  { title: "Stock List", icon: Grid2X2, href: "/stock/opening" },
];
  ...
  return (
    ...
    >
              ...
              <div className="flex items-center justify-between">
                <h1 className="text-[18px] font-bold text-slate-900">Item List</h1>
                <div className="flex items-center gap-3">
                  <button className="flex h-7 w-7 items-center justify-center rounded-md border border-green-600 bg-green-50 text-green-700">
                    +
                  </button>
                  <button className="flex h-7 w-7 items-center justify-center rounded-md border border-sky-500 bg-sky-50 text-sky-500">
                    <Grid2X2 size={14} />
                  </button>
                </div>
              </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-slate-950/20 px-6">
              <div className="w-full max-w-[860px] rounded-[22px] border border-slate-200 bg-white px-6 py-6 shadow-[0_24px_50px_rgba(15,23,42,0.18)]">
                <div className="flex items-center justify-between">
                  <h2 className="text-[16px] font-bold text-slate-900">Stock - Quick Links</h2>
                  <button
                    type="button"
                  ...
                  {quickLinks.map((link) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex items-center gap-3 rounded-[14px] border border-slate-100 bg-white px-3 py-4 text-left shadow-[0_8px_22px_rgba(15,23,42,0.07)] transition hover:-translate-y-0.5"
                      >
                        <span className="flex h-8 w-8 items-center justify-center rounded-[10px] border border-sky-300 text-sky-500">
                          <Icon size={16} />
                        </span>
